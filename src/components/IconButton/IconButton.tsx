...
const IconButton = styled(IcButton)<Props>(({ theme, variant, color }) => {
  ...
  if ((variant === "outlined" || variant === "roundedBorder") && color === "primary") {
    styleObject = {
      border: `1px solid ${alpha(theme.palette.primary.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.primary.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.secondary.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.secondary.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.error.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.error.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.warning.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.warning.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.info.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.info.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.success.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.success.main, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.text.primary, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.text.primary, theme.palette.action.focusOpacity)}`,
      },
    };
    ...
    styleObject = {
      border: `1px solid ${alpha(theme.palette.inheritWhite.main, theme.palette.action.focusOpacity)}`,
      "&:hover,&:focus": {
        border: `1px solid ${alpha(theme.palette.inheritWhite.main, theme.palette.action.focusOpacity)}`,
      },
    };
